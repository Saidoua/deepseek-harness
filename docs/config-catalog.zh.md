...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-session-rules -->
<a id="deepseek-aidsh-session-rules"></a>

## `@deepseek-ai/dsh-session-rules`

- `inject`: `agents` · `commands` · `tools` · `sessionProjections`
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-session-rules -->
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-tool-state -->
<a id="deepseek-aidsh-tool-state"></a>

## `@deepseek-ai/dsh-tool-state`

- `inject`: `agents` · `tools` · `sessionProjections`
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-tool-state -->
...
| `@deepseek-ai/dsh-compaction-prefix-slide` | `llm` · `tokenMeter` · `sessions` | [`packages/compaction/compaction-prefix-slide/src/index.ts`](../packages/compaction/compaction-prefix-slide/src/index.ts) |
...
| `@deepseek-ai/dsh-skill-stats` | `sessionProjections` | [`packages/skill/skill-stats/src/index.ts`](../packages/skill/skill-stats/src/index.ts) |
