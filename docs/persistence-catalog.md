...
| `event:agent/inbox/spliced` | event | `d02a83dc049dc11dd60e473f9514de1c7226bed01f49e91c7a06e5a76cc261c1` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:rule/pin` | event | `d0d1323bbe9cc3ba1a71e379af7dda3cd40dc57f3d733bd439b0a904513519fa` | [`event:rule/pin`](#persistence-type-eventrulepin) |
| `event:rule/unpin` | event | `e9a894a5612f6d40c81e4e7d7d278d0e7a0ce55c9c212c17de0c0318a51126a3` | [`event:rule/unpin`](#persistence-type-eventruleunpin) |
...
| `event:session/title-llm-request` | event | `5f70a09f9aa9021465b319bda88d55eb988d8909ba0e87517a57b7016287f897` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
| `event:state/write` | event | `a0c6019fa6363ca00f6b93317b15ed545fb978a1b7d7a965b46e3369edb5ec4a` | [`event:state/write`](#persistence-type-eventstatewrite) |
...
| `event:user/message` | event | `2f338a4977345043ff0d00707268238ef7052bbaf68ff4d825f4f7ee2e98a325` | [`event:user/message`](#persistence-type-eventusermessage) |
...
Sources: [`packages/core/session/src/types.ts:409`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:417`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:439`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:490`](../packages/core/session/src/types.ts)
...
Source: [`packages/context/session-rules/src/types.ts:44`](../packages/context/session-rules/src/types.ts)
...
Source: [`packages/context/session-rules/src/types.ts:50`](../packages/context/session-rules/src/types.ts)
...
Source: [`packages/todo/tool-state/src/types.ts:56`](../packages/todo/tool-state/src/types.ts)
...
SHA-256: `d02a83dc049dc11dd60e473f9514de1c7226bed01f49e91c7a06e5a76cc261c1`
...
SHA-256: `89c75ba35f0b15d13372e06188d0e0819bf338d17325c48cb5a6b0bc3ae14980`
...
SHA-256: `0f7407e4a4a7dbb533fc73d1528524be896023039e2d06647ea6bc3060310d70`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source18rules"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[18].rules`
...
| `texts` | required | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
...
| Property | Presence | Type |
|---|---|---|
| `args` | required | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
| `dt` | required | [`SessionEventEnvelope[42].sourceEventSeqs`](#persistence-type-sessioneventenvelope42sourceeventseqs) |
| `id` | required | `string` |
| `index` | required | `number` |
...
<a id="persistence-type-eventrulepin"></a>

### `event:rule/pin`

SHA-256: `d0d1323bbe9cc3ba1a71e379af7dda3cd40dc57f3d733bd439b0a904513519fa`

| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:rule/pin.data`](#persistence-type-eventrulepindata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"rule/pin"` |

<a id="persistence-type-eventrulepindata"></a>

### `event:rule/pin.data`

SHA-256: `9f8c52eecee12da68e96b2fb189211a13dcb8541ba3ae7e58d4ba8edc9adee2a`

Sources: [`packages/context/session-rules/src/types.ts:44`](../packages/context/session-rules/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `origin` | required | [`event:rule/pin.data.origin`](#persistence-type-eventrulepindataorigin) |
| `text` | required | `string` |

<a id="persistence-type-eventrulepindataorigin"></a>

### `event:rule/pin.data.origin`
...
<a id="persistence-type-eventruleunpin"></a>

### `event:rule/unpin`

SHA-256: `e9a894a5612f6d40c81e4e7d7d278d0e7a0ce55c9c212c17de0c0318a51126a3`

| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:rule/unpin.data`](#persistence-type-eventruleunpindata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"rule/unpin"` |

<a id="persistence-type-eventruleunpindata"></a>

### `event:rule/unpin.data`

SHA-256: `fc362d6c3bc744ee54ea7e008f30aff28f240db9d9882faec31b12982b643d5c`

Sources: [`packages/context/session-rules/src/types.ts:50`](../packages/context/session-rules/src/types.ts)
...
SHA-256: `5f70a09f9aa9021465b319bda88d55eb988d8909ba0e87517a57b7016287f897`
...
SHA-256: `b69f3a2f5e5d9617617def3761c5d8b0c953365bc671fcff0b55283156f2272d`
...
<a id="persistence-type-eventstatewrite"></a>

### `event:state/write`

SHA-256: `a0c6019fa6363ca00f6b93317b15ed545fb978a1b7d7a965b46e3369edb5ec4a`

| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:state/write.data`](#persistence-type-eventstatewritedata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"state/write"` |

<a id="persistence-type-eventstatewritedata"></a>

### `event:state/write.data`

SHA-256: `718738e21bd95d2813db275f01fba60418a3fd13af820da530169902f6c2545c`

Sources: [`packages/todo/tool-state/src/types.ts:56`](../packages/todo/tool-state/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `state` | required | [`event:state/write.data.state`](#persistence-type-eventstatewritedatastate) |

<a id="persistence-type-eventstatewritedatastate"></a>

### `event:state/write.data.state`

SHA-256: `7285068051e0a3640dc2a77a81e44a2c4c8c03d58092c44d8b132b01aa0563e1`

One of:

- [`packages/todo/tool-state/src/types.ts#TaskState`](#persistence-type-packagestodotool-statesrctypeststaskstate)
- `null`
...
SHA-256: `2f338a4977345043ff0d00707268238ef7052bbaf68ff4d825f4f7ee2e98a325`
...
<a id="persistence-type-packagescontextsession-rulessrctypestssessionrulessource"></a>

### `packages/context/session-rules/src/types.ts#SessionRulesSource`

SHA-256: `f6675d7944e4ff3dcc4dd8d7f98682a2dea10d58a623f49b94685bd5cd9cdc03`

Sources: [`packages/context/session-rules/src/types.ts:21`](../packages/context/session-rules/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `form` | required | `"instructions"` |
| `kind` | required | `"session-rules"` |
| `rules` | required | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
...
| Property | Presence | Type |
|---|---|---|
| `allow` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
| `deny` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
...
| Property | Presence | Type |
|---|---|---|
| `blockedBy` | required | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
| `description` | required | `string` |
| `id` | required | `string` |
...
| `writeScopes` | required | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
...
| `provider` | required | `string` |
| `reasoningEffort` | optional | `string` |
| `stop` | optional | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
...
SHA-256: `5d956124939426ff5a1d0256aaa9b91bec1ab82e0e05a361430c4a874cb7ecf8`
...
SHA-256: `bf74287957d1a020d71ccb95aea7a75337047aabdfb06fd38e9fbc20b709dda1`
...
- [`packages/context/session-rules/src/types.ts#SessionRulesSource`](#persistence-type-packagescontextsession-rulessrctypestssessionrulessource)
...
- [`packages/todo/tool-state/src/types.ts#TaskStateSource`](#persistence-type-packagestodotool-statesrctypeststaskstatesource)
...
SHA-256: `7ff52d8b07a87e7e8b2482f883a46d4da41a11e44e14704eb703e1186807a28e`
...
SHA-256: `46354dc0d37ce56ec02b88e21b3be1f94dc3405da9b2a241177cb2e2b694d36b`
...
Sources: [`packages/skill/skill/src/index.ts:154`](../packages/skill/skill/src/index.ts)
...
<a id="persistence-type-packagestodotool-statesrctypestsstatevalue"></a>

### `packages/todo/tool-state/src/types.ts#StateValue`

SHA-256: `074d6e7b5eec10b37d3493bac486dc7b894497821fc113404eeb847946030635`

Sources: [`packages/todo/tool-state/src/types.ts:17`](../packages/todo/tool-state/src/types.ts)

One of:

- [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules)
- `string`

<a id="persistence-type-packagestodotool-statesrctypeststaskstate"></a>

### `packages/todo/tool-state/src/types.ts#TaskState`

SHA-256: `f4b732eed775cb7372fc9d3ca697adc6d1e7b22759c44c1d4d194b7d554955f0`

Sources: [`packages/todo/tool-state/src/types.ts:20`](../packages/todo/tool-state/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| [`string`] | index signature | [`packages/todo/tool-state/src/types.ts#StateValue`](#persistence-type-packagestodotool-statesrctypestsstatevalue) |

<a id="persistence-type-packagestodotool-statesrctypeststaskstatesource"></a>

### `packages/todo/tool-state/src/types.ts#TaskStateSource`

SHA-256: `8bddf17cf2451b7d2b7950f6f40a1bfb3b473a176ac245d083b1eff8e8fb5ad9`

Sources: [`packages/todo/tool-state/src/types.ts:34`](../packages/todo/tool-state/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `form` | required | `"instructions"` |
| `kind` | required | `"task-state"` |
| `state` | required | [`packages/todo/tool-state/src/types.ts#TaskState`](#persistence-type-packagestodotool-statesrctypeststaskstate) |
| `update` | optional | `true` |
...
<a id="persistence-type-rulepin"></a>

### `"rule/pin"`

SHA-256: `fa7affc46e99c2615e408762d676f0f5f2bd2d687d08b92d6a974cf4b943459a`

`"rule/pin"`

<a id="persistence-type-ruleunpin"></a>

### `"rule/unpin"`

SHA-256: `c0a4eaa901d84b397d6dd860eff5a0fd6658451eb1b644200eeac463d6ed8a85`
...
<a id="persistence-type-session-rules"></a>

### `"session-rules"`

SHA-256: `0257a67d591dff658131f946df9a06cf2aa1763c965d464a13fb6f7993e058f6`
...
<a id="persistence-type-statewrite"></a>

### `"state/write"`

SHA-256: `c60927cb355f984365a94e7d4f3aa308f6819e18f96f4c1db6121669edf2bfb7`
...
<a id="persistence-type-task-state"></a>

### `"task-state"`

SHA-256: `39e08fc0119750bbc7100a0d6dbac86b67df221dbb1c7d725089042bdc94c8a3`
