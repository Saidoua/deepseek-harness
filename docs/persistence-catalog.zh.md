...
| `event:rule/pin` | event | `d0d1323bbe9cc3ba1a71e379af7dda3cd40dc57f3d733bd439b0a904513519fa` | [`{ type: "rule/pin" }`](#persistence-type-sha256-d0d1323bbe9cc3ba1a71e379af7dda3cd40dc57f3d733bd439b0a904513519fa) |
| `event:rule/unpin` | event | `e9a894a5612f6d40c81e4e7d7d278d0e7a0ce55c9c212c17de0c0318a51126a3` | [`{ type: "rule/unpin" }`](#persistence-type-sha256-e9a894a5612f6d40c81e4e7d7d278d0e7a0ce55c9c212c17de0c0318a51126a3) |
...
来源：[`packages/core/session/src/types.ts:431`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:439`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:462`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:513`](../packages/core/session/src/types.ts)
...
<a id="persistence-type-sha256-fa7affc46e99c2615e408762d676f0f5f2bd2d687d08b92d6a974cf4b943459a"></a>
...
<a id="persistence-type-sha256-c0a4eaa901d84b397d6dd860eff5a0fd6658451eb1b644200eeac463d6ed8a85"></a>
...
<a id="persistence-type-sha256-0257a67d591dff658131f946df9a06cf2aa1763c965d464a13fb6f7993e058f6"></a>
...
<a id="persistence-type-sha256-c60927cb355f984365a94e7d4f3aa308f6819e18f96f4c1db6121669edf2bfb7"></a>
...
<a id="persistence-type-sha256-39e08fc0119750bbc7100a0d6dbac86b67df221dbb1c7d725089042bdc94c8a3"></a>
...
| `id` | 必需 | `string` |
| `role` | 必需 | `"developer"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-11e30599341ccc552c99ee51e531a4d269ce63d61c9fce0776efef1483e7f9fd) |
...
| `session-rules` | `"instructions"` | `rules`: [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) | [`SessionRulesSource`](#persistence-type-sha256-f6675d7944e4ff3dcc4dd8d7f98682a2dea10d58a623f49b94685bd5cd9cdc03) |
...
| `task-state` | `"instructions"` | `state`: [`TaskState`](#persistence-type-sha256-f4b732eed775cb7372fc9d3ca697adc6d1e7b22759c44c1d4d194b7d554955f0) | [`TaskStateSource`](#persistence-type-sha256-8bddf17cf2451b7d2b7950f6f40a1bfb3b473a176ac245d083b1eff8e8fb5ad9) |
...
[`Message`](#persistence-type-sha256-4faf8a497ef159c24ff291f2c86375af08bd4945b450e65dea8b2720d2ccc645) 的数组。
...
<a id="persistence-type-sha256-f6675d7944e4ff3dcc4dd8d7f98682a2dea10d58a623f49b94685bd5cd9cdc03"></a>

<a id="persistence-type-packagescontextsession-rulessrctypestssessionrulessource"></a>

<a id="persistence-type-sessionrulessource"></a>
...
| `rules` | 必需 | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
| `update` | 可选 | `true` |
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-3f6d36ed4e1330e31075b36c62dada1a8ed3a3c1a5f4064767a6c87c5d638734) |
...
<a id="persistence-type-statevalue"></a>
...
<a id="persistence-type-sha256-f4b732eed775cb7372fc9d3ca697adc6d1e7b22759c44c1d4d194b7d554955f0"></a>

<a id="persistence-type-packagestodotool-statesrctypeststaskstate"></a>

<a id="persistence-type-taskstate"></a>
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| [`string`] | 索引签名 | [`StateValue`](#persistence-type-sha256-074d6e7b5eec10b37d3493bac486dc7b894497821fc113404eeb847946030635) |

<a id="persistence-type-sha256-8bddf17cf2451b7d2b7950f6f40a1bfb3b473a176ac245d083b1eff8e8fb5ad9"></a>

<a id="persistence-type-packagestodotool-statesrctypeststaskstatesource"></a>

<a id="persistence-type-taskstatesource"></a>
...
| `form` | 必需 | `"instructions"` |
| `kind` | 必需 | `"task-state"` |
| `state` | 必需 | [`TaskState`](#persistence-type-sha256-f4b732eed775cb7372fc9d3ca697adc6d1e7b22759c44c1d4d194b7d554955f0) |
| `update` | 可选 | `true` |
...
[`UserMessage`](#persistence-type-sha256-e0831cbaaccfed7627548cfb4b1f8f24cb6e31f4a6c39bd3b4edd123f2818471) 的数组。
...
<a id="persistence-type-sha256-7285068051e0a3640dc2a77a81e44a2c4c8c03d58092c44d8b132b01aa0563e1"></a>
...
- [`TaskState`](#persistence-type-sha256-f4b732eed775cb7372fc9d3ca697adc6d1e7b22759c44c1d4d194b7d554955f0)
- `null`
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-6f8273b40e3666850ade11baaf80b139cb69b9e735db38b62ebe7eb25d01f27c) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-e9a3253d9025c82ce55b015d8af73855053257bf8f63a49b5932264b96105adf) |
| `outcome` | 可选 | `"canceled"` |
...
<a id="persistence-type-sha256-9f8c52eecee12da68e96b2fb189211a13dcb8541ba3ae7e58d4ba8edc9adee2a"></a>
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `origin` | 必需 | [`union (2 variants)`](#persistence-type-sha256-f76f11d7f448bdc912d0db79931090d96f5528c6c7c52c0920835bbce91ae5bf) |
| `text` | 必需 | `string` |
...
<a id="persistence-type-sha256-718738e21bd95d2813db275f01fba60418a3fd13af820da530169902f6c2545c"></a>
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `state` | 必需 | [`union (2 variants)`](#persistence-type-sha256-7285068051e0a3640dc2a77a81e44a2c4c8c03d58092c44d8b132b01aa0563e1) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-201189459c3a12bdcb5fb3117b29a6c79117d383ce5df296fefe0bf7decc04e5) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-dbc9fdc01fccee5350c719a8334a5850fe6eb6fa167984e9625eaa3ff4f11eae) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
<a id="persistence-type-sha256-d0d1323bbe9cc3ba1a71e379af7dda3cd40dc57f3d733bd439b0a904513519fa"></a>
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ origin, text }`](#persistence-type-sha256-9f8c52eecee12da68e96b2fb189211a13dcb8541ba3ae7e58d4ba8edc9adee2a) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"rule/pin"` |

<a id="persistence-type-sha256-e9a894a5612f6d40c81e4e7d7d278d0e7a0ce55c9c212c17de0c0318a51126a3"></a>
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-3330178ce2ecf5d42e9e49b71bf4a27e2fe8decb486eae4381e8deda35dfbbb7) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"session/title-llm-request"` |

<a id="persistence-type-sha256-a0c6019fa6363ca00f6b93317b15ed545fb978a1b7d7a965b46e3369edb5ec4a"></a>
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ state }`](#persistence-type-sha256-718738e21bd95d2813db275f01fba60418a3fd13af820da530169902f6c2545c) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"state/write"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-e0831cbaaccfed7627548cfb4b1f8f24cb6e31f4a6c39bd3b4edd123f2818471) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
