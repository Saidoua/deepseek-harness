...
来源：[`packages/core/session/src/types.ts:409`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:417`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:439`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:490`](../packages/core/session/src/types.ts)
...
| `index` | 必需 | `number` |
| `texts` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
| `time0` | 必需 | `number` |
| `type` | 必需 | `"text-chunks"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `args` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
| `dt` | 必需 | [`SessionEventEnvelope[42].sourceEventSeqs`](#persistence-type-sessioneventenvelope42sourceeventseqs) |
| `id` | 必需 | `string` |
| `index` | 必需 | `number` |
| `name` | 可选 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:rule/pin.data`](#persistence-type-eventrulepindata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"rule/pin"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `origin` | 必需 | [`event:rule/pin.data.origin`](#persistence-type-eventrulepindataorigin) |
| `text` | 必需 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:rule/unpin.data`](#persistence-type-eventruleunpindata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"rule/unpin"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:state/write.data`](#persistence-type-eventstatewritedata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"state/write"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `state` | 必需 | [`event:state/write.data.state`](#persistence-type-eventstatewritedatastate) |
...
来源：[`packages/context/session-rules/src/types.ts:21`](../packages/context/session-rules/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `form` | 必需 | `"instructions"` |
| `kind` | 必需 | `"session-rules"` |
| `rules` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
| `update` | 可选 | `true` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `allow` | 可选 | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
| `deny` | 可选 | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `blockedBy` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
| `description` | 必需 | `string` |
| `id` | 必需 | `string` |
| `ownerId` | 可选 | `string` |
| `revision` | 必需 | `number` |
...
| `subject` | 必需 | `string` |
| `writeScopes` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
...
| `provider` | 必需 | `string` |
| `reasoningEffort` | 可选 | `string` |
| `stop` | 可选 | [`event:agent/inbox/spliced.data.inserted[0].source[18].rules`](#persistence-type-eventagentinboxspliceddatainserted0source18rules) |
...
来源：[`packages/skill/skill/src/index.ts:154`](../packages/skill/skill/src/index.ts)
...
来源：[`packages/todo/tool-state/src/types.ts:17`](../packages/todo/tool-state/src/types.ts)
...
来源：[`packages/todo/tool-state/src/types.ts:20`](../packages/todo/tool-state/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| [`string`] | 索引签名 | [`packages/todo/tool-state/src/types.ts#StateValue`](#persistence-type-packagestodotool-statesrctypestsstatevalue) |
...
来源：[`packages/todo/tool-state/src/types.ts:34`](../packages/todo/tool-state/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `form` | 必需 | `"instructions"` |
| `kind` | 必需 | `"task-state"` |
| `state` | 必需 | [`packages/todo/tool-state/src/types.ts#TaskState`](#persistence-type-packagestodotool-statesrctypeststaskstate) |
| `update` | 可选 | `true` |
