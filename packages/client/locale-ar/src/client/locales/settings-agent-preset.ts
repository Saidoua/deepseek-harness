...
export const ar = {
  ...
  userTrust: 'مخصص',
  seatHint: 'الإعداد المسبق للوكيل في الجلسة التي توشك على بدئها',
  headerHint: 'الإعداد المسبق الذي تعمل به هذه الجلسة، وقد ثُبّت عند بدئها',
  nav: 'الإعدادات المسبقة للوكيل',
  sectionIntro:
    'الإعداد المسبق هو تركيبة الإضافات التي يعمل بها وكيل الجلسة — أدواته ومطالبته وقدراته. '
  ...
  deleteDescription:
    'يُحذف مجلد الإعداد المسبق. تستمر الجلسات العاملة به، ولا تستطيع الجلسات الجديدة اختياره.',
  deleteConfirm: 'حذف',
  deleting: 'جارٍ الحذف…',
