...
export const ar = {
  ...
  'confirm.description': 'يتيح الوصول الكامل للمحادثات الجديدة تقليل خطوات التأكيد وتنفيذ إجراءات أكثر مباشرة، بما فيها العمليات الحساسة وتغيير الملفات والأوامر الخارجية. لا تستخدمه إلا إذا كنت تثق بالمهام اللاحقة.',
